...
| `06_scheme_validation.py` | Scheme rulebook validation — all six profiles (`sepa-sct`, `sepa-sdd`, `sepa-inst`, `sepa-b2b`, `xborder-ct`, `anti-duplicate`) including composition, structured violations + remediation, and the ISO 20022 charset guard |
