...
# Keep existing qualified class names and pickle paths after the internal split.
for _public_type in (
    SchemeViolation,
    ...
    _public_type.__module__ = "pain001.validation.schemes"
remediation_for.__module__ = "pain001.validation.schemes"
