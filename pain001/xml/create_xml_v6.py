...
"""
This module contains the function `create_xml_v6`, which constructs an XML tree
following the ISO 20022 pain.001.001.06 schema.
...
def create_xml_v6(root: et.Element, data: list[dict[str, Any]]) -> et.Element:
    ...
    template = env.get_template("pain.001.001.06/template.xml")
