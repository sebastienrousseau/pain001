...
"""
This module contains the function `create_xml_v8`, which constructs an XML tree
following the ISO 20022 pain.001.001.08 schema.
...
def create_xml_v8(root: et.Element, data: list[dict[str, Any]]) -> et.Element:
    ...
    template = env.get_template("pain.001.001.08/template.xml")
