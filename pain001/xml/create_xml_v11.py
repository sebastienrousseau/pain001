...
"""
This module contains the function `create_xml_v11`, which constructs an XML tree
following the ISO 20022 pain.001.001.11 schema.
...
def create_xml_v11(root: et.Element, data: list[dict[str, Any]]) -> et.Element:
    ...
    # Render the template
    xml_content = template.render(**xml_data_pain001_001_11)
