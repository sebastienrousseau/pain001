...
"""
Comprehensive tests for pain.001.001.03 (ISO 20022 Payment Initiation v03).
...
class TestPain001V3XMLGeneration(unittest.TestCase):
    """Test XML generation for pain.001.001.03 format."""
    ...
    def test_create_xml_v3_basic(self) -> None:
        ...
        result = create_xml_v3(self.root, self.test_data)
    ...
    def test_create_xml_v3_with_template(self) -> None:
    ...
    def test_create_xml_v3_namespace(self) -> None:
        """Test that correct namespace is used for pain.001.001.03."""
        result = create_xml_v3(self.root, self.test_data)
        xml_string = et.tostring(result, encoding="unicode")

        # Verify pain.001.001.03 namespace is present
...
class TestPain001V3XSDValidation(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.template_dir = Path("pain001/templates/pain.001.001.03")
    ...
    def test_xml_example_exists(self) -> None:
        ...
        abs_path = (Path(__file__).parent.parent / "pain001" / "templates" /
                   "pain.001.001.03" / "pain.001.001.03.xml")
        self.assertTrue(
...
class TestPain001V3CSVIntegration(unittest.TestCase):
    """Test CSV file integration for pain.001.001.03."""
...
class TestPain001V3DatabaseIntegration(unittest.TestCase):
    """Test SQLite database integration for pain.001.001.03."""
...
class TestPain001V3Templates(unittest.TestCase):
    """Test template files for pain.001.001.03."""
