...
"""
Comprehensive tests for pain.001.001.08 (ISO 20022 Payment Initiation v08).
...
class TestPain001V8XMLGeneration(unittest.TestCase):
    """Test XML generation for pain.001.001.08 format."""
    ...
    def test_create_xml_v8_basic(self) -> None:
        ...
        result = create_xml_v8(self.root, self.test_data)
    ...
    def test_create_xml_v8_with_template(self) -> None:
    ...
    def test_create_xml_v8_namespace(self) -> None:
        """Test that correct namespace is used for pain.001.001.08."""
        result = create_xml_v8(self.root, self.test_data)
        xml_string = et.tostring(result, encoding="unicode")

        # Verify pain.001.001.08 namespace is present
        self.assertIn("pain.001.001.08", xml_string)


@pytest.mark.skip(reason="XML example file generation not fully integrated")
class TestPain001V8XSDValidation(unittest.TestCase):
    """Test XSD validation for pain.001.001.08 format."""

    def setUp(self) -> None:
        """Set up test fixtures."""
        self.template_dir = Path("pain001/templates/pain.001.001.08")
    ...
    def test_xml_example_exists(self) -> None:
        ...
        abs_path = (Path(__file__).parent.parent / "pain001" / "templates" /
                   "pain.001.001.08" / "pain.001.001.08.xml")
        self.assertTrue(
...
class TestPain001V8CSVIntegration(unittest.TestCase):
    """Test CSV file integration for pain.001.001.08."""
...
class TestPain001V8DatabaseIntegration(unittest.TestCase):
    """Test SQLite database integration for pain.001.001.08."""
...
class TestPain001V8Templates(unittest.TestCase):
    """Test template files for pain.001.001.08."""
