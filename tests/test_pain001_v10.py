...
class TestPain001V10XMLGeneration(unittest.TestCase):
    ...
    def test_create_xml_v10_basic(self) -> None:
        ...
        result = create_xml_v10(self.root, self.test_data)
    ...
    def test_create_xml_v10_with_template(self) -> None:
    ...
    def test_create_xml_v10_namespace(self) -> None:
        ...
        # Verify pain.001.001.10 namespace is present
...
class TestPain001V10XSDValidation(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.template_dir = Path("pain001/templates/pain.001.001.10")
...
class TestPain001V10CSVIntegration(unittest.TestCase):
    """Test CSV file integration for pain.001.001.10."""
...
class TestPain001V10DatabaseIntegration(unittest.TestCase):
    """Test SQLite database integration for pain.001.001.10."""
...
class TestPain001V10Templates(unittest.TestCase):
    """Test template files for pain.001.001.10."""
